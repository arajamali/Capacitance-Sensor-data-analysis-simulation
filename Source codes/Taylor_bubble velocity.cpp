...
#include "Header.h"
using namespace std;
const int ModNum = 29500; //this number ashould be smaller than the maximum adjustment 
...
int main() {
	...
	function(Dev, ThirtySecNumb, C2, Limit_Lower_Peak, Limit_Upper_Bottom);
	...
	function(Dev, ThirtySecNumb, C3, Limit_Lower_Peak, Limit_Upper_Bottom);
